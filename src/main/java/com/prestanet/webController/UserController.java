...
import com.prestanet.domain.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<User> registrarse(@RequestBody User user) {
        ...
        User newUser = userService.registrarse(user.getUserName(), user.getPassword());
    ...
    public ResponseEntity<User> editar(@PathVariable int userId, @RequestBody User user) {
        ...
        Optional<User> updatedUser = userService.editar(userId, user.getUserName(), user.getPassword());
